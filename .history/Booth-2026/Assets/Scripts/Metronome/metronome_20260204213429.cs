...
public sealed class Metronome : MonoBehaviour
{
    ...
    [SerializeField] public float bpm = 120.0f;
    [SerializeField] public float offset = 0.0f;
    [SerializeField] public float delay = 0.1f;
    public bool isPlaying = false;
    public double startDspTime = 0.0;

    // DEFINE AUDIO SOURCE UNDER //
    [SerializeField] AudioSource musicSource;

    [SerializeField] public event Action<int, double> OnBeat; // beatIndex, beatDspTime
    ...
    private void Update()
    {
        ...
        int curBeatIndex = (int)Math.Floor(beatTime / secondsPerBeat);
