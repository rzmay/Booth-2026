...
public class CalibrationManager : BoolValueSource
{
    ...
    public Vector3 ConvertNormalizedToWorldPosition(Vector3 normalizedPosition)
    {
        ...
        {
            Debug.LogWarning("Attempting to convert normalized position to world position before calibration. Returning Vector3.zero.");
            return normalizedPosition;
        }
        Vector3 localPosition = Vector3.Scale(normalizedPosition, currentCalibration.worldScale) + positionOffset;
